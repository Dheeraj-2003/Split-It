...
@HiltViewModel
class LCViewModl @Inject constructor(
    ...
    val currentChatMessageListener : ListenerRegistration?=null
    ...
    fun populateMessages(chatId: String){
        ...
        //currentChatMessageListener = database.collection(CHATS)
    }
    ...
    fun createOrUpdateProfile(name: String?=null, number: String?=null, imageUrl: String?=null){
        ...
        val userData = UserData(uid,name?: userData.value?.name, number?: userData.value?.number,imageUrl?: userData.value?.imageUrl)
    ...
    fun onAddChat(number: String){
        ...
        if(number.isEmpty() or !number.isDigitsOnly()){
            ...
            database.collection(CHATS).where(Filter.or(
                Filter.and(
